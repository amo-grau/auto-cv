...
- **When:** ending 09.2023
- **Tags:** ros, pose-estimation, computer-vision, ai, msc, research

Full description in `education.md`.

---

## Nothing else here yet

There is a GitHub account (github.com/amo-grau) linked from the CV, but no
personal or open-source project is recorded. For software roles a reader will
click that link — if there is something there worth reading, it belongs in this
file. If there is not, that is worth knowing too.
